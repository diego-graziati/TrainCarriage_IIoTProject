...
public class DoorLockDefaults implements IBaseSimulationDefaults {
    public final boolean INITIAL_LOCK_STATUS;
    ...
    public DoorLockDefaults(String configPath) {
        JsonConfigLoader<DoorLockDefaults> loader = new JsonConfigLoader<>(configPath, DoorLockDefaults.class);
        DoorLockDefaults defaults = loader.load();

        this.INITIAL_LOCK_STATUS = defaults.INITIAL_LOCK_STATUS;
