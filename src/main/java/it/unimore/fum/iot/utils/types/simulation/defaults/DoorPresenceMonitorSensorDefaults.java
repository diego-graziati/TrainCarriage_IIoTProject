...
public class DoorPresenceMonitorSensorDefaults implements IBaseSimulationDefaults {
    ...
    public DoorPresenceMonitorSensorDefaults(String configPath) {
        JsonConfigLoader<DoorPresenceMonitorSensorDefaults> loader =
                new JsonConfigLoader<>(configPath, DoorPresenceMonitorSensorDefaults.class);
        DoorPresenceMonitorSensorDefaults defaults = loader.load();
