...
import it.unimore.fum.iot.models.HumiditySensorModel;
...
public class HumiditySensorResource extends CoapResource {
    ...
    private HumiditySensorModel model = null;
    private String devideId = null;
    private Gson gson = null;

    public HumiditySensorResource(String name, String deviceId) {
        super(name);
    ...
    private void init() {
        this.gson = new Gson();
        this.model = new HumiditySensorModel();

        setObservable(true);
        setObserveType(CoAP.Type.CON);

        getAttributes().addAttribute(OBJECT_TITLE);
        getAttributes().addAttribute("rt", "it.unimore.device.sensor.humidity");
